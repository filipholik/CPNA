...
typedef enum _Header__Type {
  ...
  HEADER__TYPE__INSTALL_REQUEST = 1,
  HEADER__TYPE__INSTALL_REPLY = 2,
  HEADER__TYPE__TABLES_LIST_REQUEST = 3,
  HEADER__TYPE__TABLES_LIST_REPLY = 4,
  HEADER__TYPE__TABLE_LIST_REQUEST = 5,
  HEADER__TYPE__TABLE_LIST_REPLY = 6,
  HEADER__TYPE__TABLE_ENTRY_GET_REQUEST = 7,
  HEADER__TYPE__TABLE_ENTRY_GET_REPLY = 8,
  HEADER__TYPE__TABLE_ENTRY_INSERT_REQUEST = 9,
  HEADER__TYPE__TABLE_ENTRY_INSERT_REPLY = 10,
  HEADER__TYPE__TABLE_ENTRY_DELETE_REQUEST = 11,
  HEADER__TYPE__TABLE_ENTRY_DELETE_REPLY = 12,
  HEADER__TYPE__PACKET_IN = 13,
  HEADER__TYPE__PACKET_OUT = 14,
  HEADER__TYPE__NOTIFY = 15
